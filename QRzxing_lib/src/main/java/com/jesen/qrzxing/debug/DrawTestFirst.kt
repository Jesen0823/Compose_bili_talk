...
import com.jesen.qrzxing.colorTransition
import com.jesen.qrzxing.floatTransition
...
fun HourglassTest() {
    ...
    Column(
        ...
        val scale = floatTransition(0.1f, 1f, 2000)
        val lineColor = colorTransition(Color.Gray, Color.Green, 2000)

        DrawRoundRectangle(scale.value, lineColor.value)
        DrawLines(scale.value, lineColor.value)
        DrawRoundRectangle(scale.value, lineColor.value)
    }
}
