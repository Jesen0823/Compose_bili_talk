 ...
 */
public class BiliStyledPlayerControlView extends FrameLayout {
    ...
    public TextView biliVideoTitle;
    public ImageView biliBackButton;
    ...
    @Nullable
    private OnExtendButtonEventListener onExtendButtonEventListener; // extend
    ...
    private BiliStyledPlayerControlViewLayoutManager controlViewLayoutManager;
    ...
    public BiliStyledPlayerControlView(Context context) {
        this(context, /* attrs= */ null);
    }

    public BiliStyledPlayerControlView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, /* defStyleAttr= */ 0);
    }

    public BiliStyledPlayerControlView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public BiliStyledPlayerControlView(
            Context context,
        ...
        controlViewLayoutManager = new BiliStyledPlayerControlViewLayoutManager(this);
        ...
        if (playPauseButton != null) {
            if (shouldShowPauseButton()) {
                ((ImageView) playPauseButton)
                        .setImageDrawable(resources.getDrawable(com.jesen.biliexoplayer.R.drawable.exo_ic_pause_circle));
                playPauseButton.setContentDescription(
                        resources.getString(R.string.exo_controls_pause_description));
            } else {
                ((ImageView) playPauseButton)
                        .setImageDrawable(resources.getDrawable(com.jesen.biliexoplayer.R.drawable.exo_ic_play_circle));
                playPauseButton.setContentDescription(
    ...
    public void switchFullScreenMode() {
        ...
        if (biliVideoTitle != null) {
            biliVideoTitle.setVisibility(isFullScreen ? View.VISIBLE : View.INVISIBLE);
        }
    }
    ...
    private final class ComponentListener
        ...
        public void onClick(View view) {
            @Nullable Player player = BiliStyledPlayerControlView.this.player;
            if (player == null) {
                return;
            }
            controlViewLayoutManager.resetHideCallbacks();
            ...
            } else if (biliBackButton == view) {
                Log.d("ControllerView--", "biliBackButton click");
                handlerBackClick(biliBackButton);
            }
        }
    }
    ...
    /*************************************extend**************************/
    public interface OnExtendButtonEventListener {

        void onExtendButtonEventClick(View button);
    }

    public void setOnExtendButtonEventListener(
            @Nullable OnExtendButtonEventListener listener) {
        onExtendButtonEventListener = listener;
    }

    public void setBiliBackButton(ImageView biliBackButton) {
        this.biliBackButton = biliBackButton;
        this.biliBackButton.setOnClickListener(componentListener);
    }

    public void setBiliVideoTitle(TextView biliVideoTitle) {
        this.biliVideoTitle = biliVideoTitle;
    }

    public TextView getBiliVideoTitle() {
        return this.biliVideoTitle;
    }

    private void handlerBackClick(ImageView biliBackButton) {
        Log.d("ControllerView--", "handlerBackClick isFullScreen");
        if (onFullScreenModeChangedListener == null) {
            return;
        }
        if (isFullScreen) {
            ...
            if (onExtendButtonEventListener != null) {
                onExtendButtonEventListener.onExtendButtonEventClick(biliBackButton);
            }
        }
    }
   ...
   /* @Override
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        Log.d("ControllerView--","keyCode:"+keyCode+",isFullScreen:"+isFullScreen);
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (isFullScreen) {
                switchFullScreenMode();
                return true;
            }else {
                return ((View)getParent()).onKeyDown(keyCode, event);
            }
        }else {
