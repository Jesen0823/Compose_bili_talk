...
/* package */ final class BiliStyledPlayerControlViewLayoutManager {
    ...
    private final BiliStyledPlayerControlView styledPlayerControlView;
    ...
    public BiliStyledPlayerControlViewLayoutManager(BiliStyledPlayerControlView styledPlayerControlView) {
        ...
        fadeOutAnimator.addListener(
                new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationStart(Animator animation) {
                        Log.d("XX-XX", "--isMinimalMode：" + isMinimalMode);
        ...
        fadeInAnimator.addListener(
                new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationStart(Animator animation) {
                        ...
                        Log.d("XX-XX", "--isMinimalMode：" + isMinimalMode + ",minimalControls" + minimalControls);
                        if (minimalControls != null) {
    ...
    public void setShowButton(@Nullable View button, boolean showButton) {
        ...
        Log.d("XX-XX", "--isMinimalMode：" + isMinimalMode + ",shouldHideInMinimalMode(button):" + shouldHideInMinimalMode(button));
    ...
    private void onLayoutChange(
        ...
        Log.d("XX-XX", "useMinimalMode:" + useMinimalMode);
        Log.d("XX-XX", "isMinimalMode:" + isMinimalMode);
    ...
    private boolean useMinimalMode() {
        ...
        Log.d("XX-XX", "centerControlWidth:" + centerControlWidth);
        Log.d("XX-XX", "centerControlWidth  second:" + getWidthWithMargins(timeView) + getWidthWithMargins(overflowShowButton));
