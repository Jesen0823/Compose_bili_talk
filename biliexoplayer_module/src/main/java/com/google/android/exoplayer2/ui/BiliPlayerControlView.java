...
import com.jesen.biliexoplayer.player.ExoEventListener;
 ...
 */
public class BiliPlayerControlView extends FrameLayout {
    ...
    public BiliPlayerControlView(Context context) {
        this(context, /* attrs= */ null);
    }

    public BiliPlayerControlView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, /* defStyleAttr= */ 0);
    }

    public BiliPlayerControlView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void doPlay() {
        if (BiliPlayerControlView.this.player == null) return;
        dispatchPlay(BiliPlayerControlView.this.player);
    }

    public void doPause() {
        if (BiliPlayerControlView.this.player == null) return;
        dispatchPause(BiliPlayerControlView.this.player);
    }
    ...
    private final class ComponentListener
        ...
        public void onClick(View view) {
            Player player = BiliPlayerControlView.this.player;
            if (player == null) {
                return;
            }
            if (nextButton == view) {
